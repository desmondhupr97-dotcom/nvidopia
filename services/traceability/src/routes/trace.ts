...
import { Requirement, Commit, Issue } from '@nvidopia/data-models';
import { asyncHandler } from '@nvidopia/service-toolkit';

const router = Router();

router.get('/trace/forward/:req_id', asyncHandler(async (req: Request, res: Response) => {
...
router.get('/trace/backward/:issue_id', asyncHandler(async (req: Request, res: Response) => {
...
router.get('/trace/impact/:issue_id', asyncHandler(async (req: Request, res: Response) => {
  const { issue_id } = req.params;
...
router.get('/trace/coverage', asyncHandler(async (_req: Request, res: Response) => {
